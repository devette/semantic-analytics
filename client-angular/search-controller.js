(function() {
    ...
    */
    ...
    /* @ngInject */
    function MainController($scope, FacetHandler, searchService, facetUrlStateHandlerService) {
        var vm = this;
        ...
        // Get the facet configurations from searchService.
        vm.facets = searchService.getFacets();
        ...
        function getFacetOptions() {
            var options = searchService.getFacetOptions();
            options.scope = $scope;
        ...
        function updateResults(event, facetSelections) {
            ...
            // The searchService returns a (promise of a) pager object.
            return searchService.getResults(facetSelections)
            .then(function(pager) {
                if (uid === updateId) {
                    vm.pager = pager;
